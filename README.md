...
- [4. 분석 결과 및 시각화](REPORT.md#4-분석-결과-및-시각화)
  - [적용한 시계열 분석 기법과 시각화 설계](REPORT.md#적용한-시계열-분석-기법과-시각화-설계)
...
- [10. 보완하지 않은 부분에 대한 코멘트](REPORT.md#10-보완하지-않은-부분에-대한-코멘트)
...
## 데이터 출처 및 라이선스
국토교통부 아파트매매 실거래자료 (공공데이터포털 Open API, 이용허락범위 제한 없음). 자세한 출처·기간·정제 기준은 [REPORT.md — 데이터 설명](REPORT.md#3-데이터-설명) 참고.
